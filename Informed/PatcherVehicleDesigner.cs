...
namespace ZyMod.MarsHorizon.Informed {
   ...
   internal class PatcherVehicleDesigner : ModPatcher {
      ...
      private static readonly MethodInfo FreeAll = typeof( SimplePooler< VehicleDesignerTooltip > ).Method( "FreeAll", 0 );
      private static readonly MethodInfo Get = typeof( SimplePooler< VehicleDesignerTooltip > ).Method( "Get", 0 );
